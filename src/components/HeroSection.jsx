      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-black uppercase leading-[1.1] tracking-tight">
              Building <br/>
              <span className="bg-primary text-primary-foreground px-2">Systems</span> &<br/>
              Algorithms
            </h1>

            <p className="text-lg sm:text-xl md:text-2xl text-foreground font-mono font-medium max-w-lg">
            ...
            <div className="flex flex-wrap items-center gap-6 pt-8 border-t-4 border-border w-full max-w-max">
          ...
          <motion.div
            ...
            className="relative mt-8 lg:mt-0 w-full max-w-sm mx-auto lg:max-w-none"
          >
            <div className="aspect-square bg-secondary text-secondary-foreground border-4 border-border shadow-[16px_16px_0_0_var(--color-border)] relative z-10 overflow-hidden group p-8 flex flex-col justify-between">
                ...
                <div className="text-right">
                  <span className="bg-primary text-white font-black text-5xl md:text-6xl px-2 py-0 border-3 border-border">1000+</span>
            ...
            <div className="absolute -top-6 -left-4 sm:-top-8 sm:-left-8 w-28 sm:w-32 h-8 bg-card border-4 border-border shadow-[4px_4px_0_0_var(--color-border)] z-20 transform -rotate-12 flex items-center justify-center font-black text-sm sm:text-base">HELLO_WORLD</div>
          </motion.div>
        </div>
      </div>
    </section>
